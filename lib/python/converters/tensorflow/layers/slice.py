...
from converters.tensorflow.util import TensorNotFoundError
...
class SliceLayerBuilder(LayerBuilder):
    def build_layer(self, converter_context, descriptor, input_descriptors, output_descriptors):
        ...
        split_points = self.get_split_positions(input_shape[1:], descriptor.split_count, descriptor.split_sizes,
                                                descriptor.axis)
