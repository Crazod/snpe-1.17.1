...
class Buffer(object):
    ...
    def get_axis_order(self):
        ...
        if self.axis_format == 'NSC':
            return [AxisAnnotation.BATCH, AxisAnnotation.CHANNEL, AxisAnnotation.HEIGHT, AxisAnnotation.WIDTH]
        if self.axis_format == 'NCS':
            return [AxisAnnotation.BATCH, AxisAnnotation.HEIGHT, AxisAnnotation.WIDTH, AxisAnnotation.CHANNEL]
        elif self.axis_format == 'FEATURE':
            return [AxisAnnotation.BATCH, AxisAnnotation.FEATURE]
            ...
            return [AxisAnnotation.NONTRIVIAL]
        else:
